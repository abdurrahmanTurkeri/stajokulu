    ...
    <body>
        <div class="wrapper" >
            ...
            <%
                ...
                List<User> userList = userService.kullaniciListesiAl();
            ...
            %>
            <div class="user">  <%=user.getId()%>  <%=user.getFirstName()%> - <%=user.getLastName()%></div>
            <%}
            %>
            ...
            <jsp:useBean id="userController" class="com.stajokulu.service.UserService" scope="session">
                <jsp:setProperty name="bean" property="*"/>
            </jsp:useBean>
            <c:forEach items="${userController.userList}" var="kullanici" varStatus="index">
                <div class="user">  ${kullanici.id } ${kullanici.firstName } - ${kullanici.lastName }</div>
            </c:forEach>
